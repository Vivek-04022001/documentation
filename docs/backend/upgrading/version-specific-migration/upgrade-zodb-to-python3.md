...
If there are log messages during the migration or during `zodbverify`, that doesn't necessarily mean the migration didn't work, or that your database is broken.
...
These items most likely remain, and weren't removed properly and aren't used.
